 ...
 * @author HANY
 */
public class NiveauCinq {

    private Form niveauCinq;
    int repSuccniv1 = 0;
    int repEchniv1 = 0;
    ...
    public NiveauCinq(Resources theme) {
        try {
        ...
        con.setUrl("http://127.0.0.1/pi/hani/selectNivDeux.php");
...
// form.add(cellForRow(s,theme));
    ...
    public Form getNiveauCinq() {
        return niveauCinq;
    }

    public void setNiveauCinq(Form niveauCinq) {
        this.niveauCinq = niveauCinq;
    }
