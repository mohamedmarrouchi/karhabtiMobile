 ...
 * @author HANY
 */
public class NiveauSix {

    private Form niveauSix;
    int repSuccniv1 = 0;
    int repEchniv1 = 0;
    ...
    public NiveauSix(Resources theme) {
        try {
...
// form.add(cellForRow(s,theme));
    ...
    public Form getNiveauSix() {
        return niveauSix;
    }

    public void setNiveauSix(Form niveauSix) {
        this.niveauSix = niveauSix;
    }
