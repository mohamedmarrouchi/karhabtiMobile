...
public class NiveauUn {
    ...
    public NiveauUn(Resources theme) {
        try {
        ...
        con.setUrl("http://127.0.0.1/pi/hani/selectNivUn.php");
...
// form.add(cellForRow(s,theme));
    ...
    public Form getNiveauUn() {
        return niveauUn;
    }

    public void setNiveauUn(Form niveauUn) {
    ...
    public void checkrep(ArrayList<String> x, ArrayList<String> y) {
     ...
     res.getToolbar().setBackCommand("", e -> {

           NiveauUn s = new NiveauUn(theme);
