...
public class NiveauQuatre {
    ...
    public NiveauQuatre(Resources theme) {
        try {
...
// form.add(cellForRow(s,theme));
    ...
    public Form getNiveauQuatre() {
        return niveauQuatre;
    }

    public void setNiveauQuatre(Form niveauQuatre) {
