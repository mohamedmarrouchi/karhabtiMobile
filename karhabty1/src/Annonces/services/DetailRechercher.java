 ...
 * @author root
 */
public class DetailRechercher extends Form{
    private Form f1;
    ...
    public DetailRechercher(Annonces annonce,Resources theme_1,String titre,String region, String boite){
   ...
   setTitle("Détail");
    ...
    Container ctn4 = new Container(new BoxLayout(BoxLayout.Y_AXIS));
            ...
            new RetourRecherche(theme_1,titre,region,boite);
        });
