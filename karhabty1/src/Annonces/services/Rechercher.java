 ...
 * @author root
 */
public class Rechercher extends Form{
    ArrayList<Annonces> listEtudiants = new ArrayList<>();
    ArrayList<Annonces> listEtudiant = new ArrayList<>();
       Form f1,list;
       public Rechercher(Resources theme_1){
            UIBuilder uib = new UIBuilder();

        Container ctn1 = uib.createContainer(theme_1, "Rechercher");
        f1 = ctn1.getComponentForm();
        f1.setTitle("Rechercher");
        ...
        Button rechercher = (Button) uib.findByName("rechercher", ctn1);
        ...
        con.setUrl("http://127.0.0.1/pi/rechercher.php?&TITRE="+txttitre.getText()+"&REGION="+txtregion.getText()+"&BOITE="+txtboite.getText());
...
//
 //list = new Form("List", BoxLayout.y());
   ...
   getToolbar().setBackCommand("", e -> {
            ...
            new Rechercher(theme_1).getF1().showBack();
        });
...
for (Annonces a : getListEtudiant(new String(con.getResponseData()))){
        ...
        lblSurnom.addPointerReleasedListener(e->{
            ...
            //display detail
          new DetailRechercher(a,theme_1,txttitre.getText(),txtregion.getText(),txtboite.getText()).show();
//            d.getF1().show();
                       // displayDetail(a);
