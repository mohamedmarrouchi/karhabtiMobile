...
public class Acceuil extends Form{
    ...
    public Acceuil(Resources theme_1) {
...
//for (Annonces a : listS){
        ...
        //slideMenu
        Command cmd1 = new Command("Annonces");
        Command cmd2 = new Command("Offres");
        Command cmd3 = new Command("Code De La Route");
        ...
        addCommandListener(e -> {
            ...
            if (e.getCommand() == cmd1) {
             new ListAnnonces(theme_1).show();
                ...
                HomeForm s1 = new HomeForm(theme_1);
            }
